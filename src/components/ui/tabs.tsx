...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-10 items-center justify-center rounded-md bg-[var(--sky-surface-overlay)] p-1 text-[var(--sky-text-muted)] bg-[var(--sky-surface-overlay)] dark:text-[var(--sky-text-muted)]",
      className
    )}
    {...props}
  />
